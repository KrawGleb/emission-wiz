...
internal class MapImageBuilder : IMapImageBuilder
{
    ...
    public void DrawShape(Models.Map.Shapes.Shape shape)
    {
        if (shape.GetType() == typeof(Circle))
        {
            ...
            {
                SimpleCoordinates = circle.Center
            });
        }
    }
    ...
    {
        return $"lonlat:{marker.SimpleCoordinates.Lon},{marker.SimpleCoordinates.Lat};type:material;color:red;size:small;iconsize:small;textsize:small;shadow:no";
    }
